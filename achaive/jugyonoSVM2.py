...
#小説ファイルをリストアップ
def makeFileList(file_list:dict,listname:str,category:str):
    file_list[listname]=[]
...
for target in targets:
    file_list = makeFileList(file_list,target,category_reverse_dict[target])
    #print(len(file_list[target]))
