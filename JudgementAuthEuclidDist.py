...
dataL = m.readFile(main_author,dic,"OneHotVectorEuclid",str(cate)+"Learn",vector,window,epoc,sep,"#","#",extension,"../result/euclid/")
dataL = m.readFile(main_author,dic,"WordVectorEuclid",str(cate)+"Learn",vector,window,epoc,sep,"#","#",extension,"../result/euclid/")
...
for line in mahala_listL:
  if(line[0]==main_author):
    ...
    print(m.nameFile(main_author,dic,"OneHotVectorEuclid",str(cate)+"Learn",vector,window,epoc,sep,"#","#",extension))
    print(m.nameFile(main_author,dic,"WordVectorEuclid",str(cate)+"Learn",vector,window,epoc,sep,"#","#",extension))
    exit()

#ファイル読み出し
dataT = m.readFile(main_author,dic,"OneHotVectorEuclid",str(cate)+"Test",vector,window,epoc,sep,"#","#",extension,"../result/euclid/")
dataT = m.readFile(main_author,dic,"WordVectorEuclid",str(cate)+"Test",vector,window,epoc,sep,"#","#",extension,"../result/euclid/")
# ファイル内で使用されている単語を1次元リスト化
...
for line in mahala_listT:
  if(line[0]==works[T_IdIndex[int(line[3])]].author):
    ...
    T_mahala_dists.append(float(line[1]))
  else:
    print("main author's learn works mahala dist is not found in...")
    print(m.nameFile(main_author,dic,"OneHotVectorEuclid",str(cate)+"Learn",vector,window,epoc,sep,"#","#",extension))
    print(m.nameFile(main_author,dic,"WordVectorEuclid",str(cate)+"Learn",vector,window,epoc,sep,"#","#",extension))
...
print(L_mahala_dists)
print("border is : ",border)
print("min test dist is : ",min(T_mahala_dists))
